...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xml2js$2f$lib$2f$xml2js$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/xml2js/lib/xml2js.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ChatboxLanding() {
    ...
    async function xmlToString(xml) {
        const parsed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xml2js$2f$lib$2f$xml2js$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseStringPromise"])(xml, {
            explicitArray: false,
        ...
        if (Array.isArray(parsed.boltArtifact.boltAction)) {
            parsedBoltActions = parsed.boltArtifact.boltAction;
        } else {
            parsedBoltActions = [
                parsed.boltArtifact.boltAction
            ];
        }
        console.log(parsedBoltActions);
        let allSteps = [];
        for(let i = 0; i < parsedBoltActions.length; i++){
            let newStep = {
                title: parsedBoltActions[i].$.filePath,
                status: "Pending",
                content: parsedBoltActions[i]._ || ""
            };
    ...
    async function promptResponseFromAi(postBody) {
        try {
            ...
            console.log("modified", modifiedXML);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d508442d._.js.map